...
describe('collectBackendInstallDiagnostics', () => {
  it('records packaged runtime manifest and missing backend binary metadata', () => {
    const files = new Map<string, { mtimeMs: number; size: number; content?: string }>([
      ['C:\\TjuaeUI\\resources', { mtimeMs: 1000, size: 0 }],
      ['C:\\TjuaeUI\\resources\\bundled-tjuaecore\\win32-x64', { mtimeMs: 2000, size: 0 }],
      [
        'C:\\TjuaeUI\\resources\\bundled-tjuaecore\\win32-x64\\manifest.json',
        {
          mtimeMs: 3000,
          size: 88,
          content: JSON.stringify({
            ...
            sourceType: 'download',
            files: ['tjuaecore.exe', 'managed-resources/'],
          }),
        },
      ],
    ]);
    ...
    const diagnostics = collectBackendInstallDiagnostics(
      {
        ...
        resourcesPath: 'C:\\TjuaeUI\\resources',
        checkedBundledPath: 'C:\\TjuaeUI\\resources\\bundled-tjuaecore\\win32-x64\\tjuaecore.exe',
      },
      {
        appVersion: '2.1.7',
        arch: 'x64',
        execPath: 'C:\\TjuaeUI\\TjuaeUI.exe',
        isPackaged: true,
        platform: 'win32',
    ...
    expect(diagnostics).toEqual({
      ...
      binaryExists: false,
      binaryName: 'tjuaecore.exe',
      binaryPath: 'C:\\TjuaeUI\\resources\\bundled-tjuaecore\\win32-x64\\tjuaecore.exe',
      bundledDirPath: 'C:\\TjuaeUI\\resources\\bundled-tjuaecore',
      execPath: 'C:\\TjuaeUI\\TjuaeUI.exe',
      isPackaged: true,
      manifestExists: true,
      manifestFiles: ['tjuaecore.exe', 'managed-resources/'],
      manifestGeneratedAt: '2026-05-29T12:00:00.000Z',
      manifestPath: 'C:\\TjuaeUI\\resources\\bundled-tjuaecore\\win32-x64\\manifest.json',
      manifestSize: 88,
      ...
      runtimeDirPath: 'C:\\TjuaeUI\\resources\\bundled-tjuaecore\\win32-x64',
      runtimeKey: 'win32-x64',
    });
  });
});
