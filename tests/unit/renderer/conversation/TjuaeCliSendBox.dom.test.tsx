...
import TjuaeCliSendBox from '@/renderer/pages/conversation/platforms/tjuaecli/TjuaeCliSendBox';
...
vi.mock('@/renderer/pages/conversation/platforms/tjuaecli/useTjuaeCliMessage', () => ({
  useTjuaeCliMessage: () => ({
...
} as TjuaeCliModelSelection;

describe('TjuaeCliSendBox', () => {
  beforeEach(() => {
    vi.clearAllMocks();
