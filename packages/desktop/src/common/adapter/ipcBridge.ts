...
export const acpConversation = {
  ...
  checkAllManagedAgentHealth: httpPost<import('@/renderer/utils/model/agentTypes').ManagedAgent[], void>(
  ...
  testA2aAgent: httpPost<
    { name: string; version?: string; endpoint: string },
    { endpoint: string; auth_type?: string; auth_token?: string; allow_insecure?: boolean }
  >('/api/agents/custom/try-connect-a2a'),
