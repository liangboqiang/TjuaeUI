...
import { TjuaeSearchInput, TjuaeInlineSearchInput } from '@renderer/components/base';
...
type Props = {
  ...
  /**
   * 搜索框样式：'default' 用常驻搜索栏样式（TjuaeSearchInput，34px 描边）；
   * 'inline' 用下拉列表专用的柔和样式（TjuaeInlineSearchInput，浅灰填充无边框）。
