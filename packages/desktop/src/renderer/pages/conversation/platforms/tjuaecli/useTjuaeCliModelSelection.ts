...
export type TjuaeCliModelSelection = {
...
export type UseTjuaeCliModelSelectionOptions = {
  initialModel: TProviderWithModel | undefined;
  onSelectModel: (provider: IProvider, modelName: string) => Promise<boolean>;
};

export const useTjuaeCliModelSelection = ({
  initialModel,
  onSelectModel,
}: UseTjuaeCliModelSelectionOptions): TjuaeCliModelSelection => {
  ...
  // TjuaeCore does not support Google Auth — filter it out
