...
const TjuaeCliModelSelector: React.FC<{
  selection?: TjuaeCliModelSelection;
  disabled?: boolean;
  ...
  // tjuaecli models are grouped by provider. Use a composite id (see compositeId)
...
export default TjuaeCliModelSelector;
