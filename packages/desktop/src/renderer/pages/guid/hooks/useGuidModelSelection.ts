...
type ProviderAgentKey = 'tjuaecli';
 ...
 * @param agentKey - current provider-based agent (currently only 'tjuaecli')
 */
export const useGuidModelSelection = (agentKey: ProviderAgentKey = 'tjuaecli'): GuidModelSelectionResult => {
