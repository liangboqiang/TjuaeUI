...
const ChannelModalContent: React.FC = () => {
  ...
  const channels: ChannelConfig[] = useMemo(() => {
    const telegramChannel: ChannelConfig = {
      ...
      description: t('settings.channels.telegramDesc', 'Chat with TjuaeUI assistant via Telegram'),
      status: 'active',
    ...
    const larkChannel: ChannelConfig = {
      ...
      description: t('settings.channels.larkDesc', 'Chat with TjuaeUI assistant via Lark or Feishu'),
      status: 'active',
    ...
    const dingtalkChannel: ChannelConfig = {
      ...
      description: t('settings.channels.dingtalkDesc', 'Chat with TjuaeUI assistant via DingTalk'),
      status: 'active',
    ...
    const weixinChannel: ChannelConfig = {
      ...
      description: t('settings.channels.weixinDesc', 'Chat with TjuaeUI assistant via WeChat'),
      status: 'active',
    ...
    const wecomChannel: ChannelConfig = {
      ...
      description: t('settings.channels.wecomDesc', 'Chat with TjuaeUI assistant via WeCom (Enterprise WeChat)'),
    ...
    const comingSoonChannels: ChannelConfig[] = [
      {
        ...
        description: t('settings.channels.slackDesc', 'Chat with TjuaeUI assistant via Slack'),
        status: 'coming_soon' as const,
        enabled: false,
        disabled: true,
        content: (
      ...
      },
      {
        ...
        description: t('settings.channels.discordDesc', 'Chat with TjuaeUI assistant via Discord'),
        status: 'coming_soon' as const,
        enabled: false,
        disabled: true,
        content: (
  ...
  const channelGuideText = t('settings.webui.featureChannelsDesc', {
    defaultValue: 'Connect Telegram, Lark, and DingTalk to interact with TjuaeUI from IM apps.',
  });
  ...
  return (
    <TjuaeScrollArea className={isPageMode ? 'h-full' : ''}>
