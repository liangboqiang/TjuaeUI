...
type TjuaeSelectSize = NativeSelectSize | 'middle';

export interface TjuaeSelectProps extends NativeSelectProps {
  /** 额外的类名 / Additional class name */
  className?: string;
  /** 统一尺寸，新增 middle（32px）/ Unified size with additional "middle" (32px) */
  size?: TjuaeSelectSize;
}

/**
 * 基础样式类名
 * 注意：主题相关样式（背景色、边框色）在 arco-override.css 的 .tjuae-select 类中定义
 * Note: Theme-related styles (background, border colors) are defined in .tjuae-select class in arco-override.css
 */
 ...
 * ```tsx
 * // 基本用法 / Basic usage
 * <TjuaeSelect placeholder="请选择" style={{ width: 200 }}>
 *   <TjuaeSelect.Option value="1">选项1</TjuaeSelect.Option>
 *   <TjuaeSelect.Option value="2">选项2</TjuaeSelect.Option>
 * </TjuaeSelect>
 *
 * // 多选 / Multiple selection
 * <TjuaeSelect mode="multiple" placeholder="请选择多个">
 *   <TjuaeSelect.Option value="1">选项1</TjuaeSelect.Option>
 *   <TjuaeSelect.Option value="2">选项2</TjuaeSelect.Option>
 * </TjuaeSelect>
 *
 * // 分组 / Grouped options
 * <TjuaeSelect placeholder="请选择">
 *   <TjuaeSelect.OptGroup label="分组1">
 *     <TjuaeSelect.Option value="1">选项1</TjuaeSelect.Option>
 *   </TjuaeSelect.OptGroup>
 *   <TjuaeSelect.OptGroup label="分组2">
 *     <TjuaeSelect.Option value="2">选项2</TjuaeSelect.Option>
 *   </TjuaeSelect.OptGroup>
 * </TjuaeSelect>
 * ```
 *
 * @see arco-override.css for theme-related styles (.tjuae-select)
 */
const mapSizeToNative = (size?: TjuaeSelectSize): NativeSelectSize | undefined => {
  if (!size) return undefined;
  if (size === 'middle') return 'default';
  return size;
};

type TjuaeSelectComponent = React.ForwardRefExoticComponent<TjuaeSelectProps & React.RefAttributes<SelectHandle>> & {
  Option: typeof Select.Option;
  OptGroup: typeof Select.OptGroup;
};

const InternalSelect = React.forwardRef<SelectHandle, TjuaeSelectProps>(
...
const TjuaeSelect = InternalSelect as TjuaeSelectComponent;

TjuaeSelect.displayName = 'TjuaeSelect';

// 导出子组件 / Export sub-components
TjuaeSelect.Option = Select.Option;
TjuaeSelect.OptGroup = Select.OptGroup;

export default TjuaeSelect;
