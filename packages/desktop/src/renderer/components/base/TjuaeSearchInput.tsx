...
const TjuaeSearchInput = forwardRef<HTMLInputElement, TjuaeSearchInputProps>((props, ref) => {
  const {
    value,
    onChange,
    placeholder,
...
TjuaeSearchInput.displayName = 'TjuaeSearchInput';

export default TjuaeSearchInput;
