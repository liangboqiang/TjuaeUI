export const WORKSPACE_TOGGLE_EVENT = 'tjuaeui-workspace-toggle';
export const WORKSPACE_STATE_EVENT = 'tjuaeui-workspace-state';
export const WORKSPACE_HAS_FILES_EVENT = 'tjuaeui-workspace-has-files';
